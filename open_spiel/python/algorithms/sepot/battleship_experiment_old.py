...
# Game Setting 
parser.add_argument("--height", default=5, type=int, help="Goofspiel cards")
parser.add_argument("--width", default=5, type=int, help="Goofspiel cards")
parser.add_argument("--ships", default=[3, 2, 2], nargs="+", type=int, help="Ship sizes")
...
def cont_train():
  ...
  file = save_folder + "/rnad_987456_35000.pkl"
